# Generated by Django 5.0.7 on 2025-01-24 06:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.IntegerField(choices=[(1, 'doctor'), (2, 'patient'), (3, 'admin')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('referral_id', models.CharField(default=account.models.generate_referral_id, max_length=10, unique=True)),
